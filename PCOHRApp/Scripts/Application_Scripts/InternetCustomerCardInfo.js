...
function loadCustomerDropdown() {
    $('#customerId').select2({
        ajax: {
            url: '/InternetCustomer/GetCustomerCardInfoListForDropdown',
...
$('#btnSaveId').click(function () {
    ...
    if ($('#customerInfoId').val() == '0' || $('#customerInfoId').val() == '') {
        ...
        $.post('/InternetCustomer/InsertOrUpdateCustomerCardInfo', inputData, function (data) {
...
function loadCustomerInfoList() {
    ...
    $('#customerCardListTableId').DataTable({
        ...
        "ajax":
        {
            "url": '/InternetCustomer/GetCustomerCardInfoList',
            "type": "POST",
            "datatype": "json"
        },
        //"responsive": true,
...
function EditCustomerCardInfo(id) {
    debugger;
    $.get('/InternetCustomer/GetCustomerCardInfoById/' + id, function (data) {
        debugger;
        if (data.success) {
            //loadCreateUI();
