...
{
    public class DishBillCollectionDA
    {
        ...
        public List<PreviousBillInfoVM> GetPreviousInfoList(int cid)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("gsp_getDishRemaingBillByCid", con);
        ...
        public PayedBillVM GetLastPaidBill(int cid)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getLastPayedBillForDish", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@id", cid);
                con.Open();
                var da = new SqlDataAdapter(cmd);
        ...
        public string InsertBillCollection(BillCollectionVM _obj)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("isp_DishCustomerBillCollection", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<BillCollectionVM> GetBillCollectionList()
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getDishBillCollections", con);
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
                var da = new SqlDataAdapter(cmd);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<BillCollectionVM> GetBillCollectionListBySerial(string pageNo, string serialNo, int yearID)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getDishBillCollectionsBySeriaNo", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<BillCollectionVM> GetBillUnCollectionList(DateTime fromDate, DateTime toDate, int receivedBy)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getDishUnCollections", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int UpdateCollectionStatus(List<BillCollectionVM> _objs, int createdBy)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("usp_updateDishCollectionStatus", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int DeleteCollection(int collectionId, int createdBy)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    SqlCommand cmd = new SqlCommand("dsp_deleteDishBillCollection", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public decimal GetMonthlyBill(int cid, DateTime? fromMonthDate, DateTime? toMonthDate)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    SqlCommand cmd = new SqlCommand("gsp_getDishMonthlyBill", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public decimal GetMonthlyBill(BillCollectionVM _obj)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    SqlCommand cmd = new SqlCommand("gsp_getDishMonthlyBillByCollectionId", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<BillCollectionVM> GetPagesByYear(int yearId,int receivedBy)
        {
            DataTable dt = new DataTable();
                    List<BillCollectionVM> pageList = new List<BillCollectionVM>();
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getDishPagesByYear", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@yearId", yearId);
                cmd.Parameters.AddWithValue("@receivedBy", receivedBy);
                con.Open();
        ...
        public List<BillCollectionVM> GetPagesByYear(int yearId)
        {
            DataTable dt = new DataTable();
            List<BillCollectionVM> pageList = new List<BillCollectionVM>();
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getDishPages", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@yearId", yearId);               
                con.Open();
                var da = new SqlDataAdapter(cmd);
        ...
        public List<BillDelete> GetMonthlyBillDeleteList()
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("sp_GetDishMonthlyDeleteHis", con);
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
                var da = new SqlDataAdapter(cmd);
                cmd.CommandType = CommandType.StoredProcedure;
