...
namespace PCOHRApp.DA
{
    public class InternetCustomerDA
    {
        ...
        public string InsertOrUpdateCustomerCardInfo(CustomerCardInfoVM _obj)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("isp_InternetCustomerCardInfo", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<CustomerCardInfoVM> GetCustomerCardInfoList()
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getInternetCustomerCardInfo", con);
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
                var da = new SqlDataAdapter(cmd);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<CustomerVM> GetCustomerCardInfoListForDropdown()
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getInternetCustomerCardInfoForDropdown", con);
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
                var da = new SqlDataAdapter(cmd);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public CustomerCardInfoVM GetCustomerCardInfoById(int id)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getInternetCustomerCardInfoById", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@id", id);
                con.Open();
                SqlDataReader rdr = cmd.ExecuteReader();
