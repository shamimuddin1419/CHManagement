...
{
    public class DishBillGenerateDA
    {
        ...
        public int InsertBillGenerate(BillGenerateVM _obj)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("isp_DishCustomerBillGenerate", con);
        ...
        public List<BillGenerateVM> GetBillList(string month, int year )
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getDishBills", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int DeleteBill(int billDetailId, int createdBy)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    SqlCommand cmd = new SqlCommand("dsp_deleteDishBill", con);
                    cmd.CommandType = CommandType.StoredProcedure;
