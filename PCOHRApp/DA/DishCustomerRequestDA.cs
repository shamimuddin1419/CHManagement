...
{
    public class DishCustomerRequestDA
    {
        ...
        public int InsertCustomerRequest(CustomerRequestVM _obj)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("isp_DishCustomerRequest", con);
        ...
        public List<CustomerRequestVM> GetCustomerRequestList()
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("gsp_getDishCustomerRequests", con);
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
        ...
        public int DeleteCustomerRequest(int requestId,int createdBy)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    SqlCommand cmd = new SqlCommand("dsp_deleteDishCustomerRequest", con);
                    cmd.CommandType = CommandType.StoredProcedure;
