...
{
    public class DishCustomerRequestController : Controller
    {
        private DishCustomerRequestDA _dishCustomerRequestDA;
        public DishCustomerRequestController()
        {
            _dishCustomerRequestDA = new DishCustomerRequestDA();
        }
        // GET: DishCustomerRequest
        ...
        public JsonResult GetCustomerRequestList()
        {
            try
            {
                List<CustomerRequestVM> _objList = _dishCustomerRequestDA.GetCustomerRequestList().OrderByDescending(x => x.requestId).ToList();
        ...
        public JsonResult DeleteCustomerRequest(int id)
        {
            try
            {
                ...
                int result = _dishCustomerRequestDA.DeleteCustomerRequest(id, createdBy);
