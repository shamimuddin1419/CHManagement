...
{
    public class DishMonthlyBillDeleteListController : Controller
    {
         private DishBillCollectionDA _DishBillCollectionDA;
         public DishMonthlyBillDeleteListController()
        {
            _DishBillCollectionDA = new DishBillCollectionDA();
        }
       
        [CustomSessionFilterAttribute]
         // GET: /DishMonthlyBillDeleteLis/
        ...
        public JsonResult GetMonthlyBillDeleteList()
        {
            try
            {
                List<BillDelete> _objList = _DishBillCollectionDA.GetMonthlyBillDeleteList().OrderByDescending(x => x.ID).ToList();
