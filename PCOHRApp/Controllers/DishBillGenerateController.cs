...
{
    public class DishBillGenerateController : Controller
    {
        private DishBillGenerateDA _dishBillGenerateDA;
        public DishBillGenerateController()
        {
        ...
        public JsonResult InsertBillGenerate(BillGenerateVM _obj)
        {
            try
            {
                ...
                int result = _dishBillGenerateDA.InsertBillGenerate(_obj);
        ...
        public JsonResult GetBillGenerateList(string month, int year)
        {
            try
            {
                List<BillGenerateVM> _objList = _dishBillGenerateDA.GetBillList(month,year).OrderByDescending(x => x.billDetailId).ToList();
        ...
        public JsonResult DeleteBill(int id)
        {
            try
            {
                ...
                int result = _dishBillGenerateDA.DeleteBill(id, createdBy);
